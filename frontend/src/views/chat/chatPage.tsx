...
const ChatPage = () => {
  ...
  useEffect(() => {
    ...
    socketInstance.on('receiveMessages', (existingMessages) => {
      ...
      const sortedMessages = existingMessages.sort((a, b) => new Date(a.date_envoi) - new Date(b.date_envoi));
    ...
    socketInstance.on('receiveMessage', (newMessage) => {
      ...
      setMessages((prev) => [...prev, { ...newMessage, isMine: newMessage.senderId === senderId }]);
    });
